...
- [script](https://pad.riseup.net/p/OMlf7RmItLSCEhM_ZC5B)
  collapsed:: true
	...
	- **one liner**
	  collapsed:: true
	  2 22s 59w
		- this is pondlife: discone (a videogame). an online multiplayer, momentum-based 3d-platformer. a difficult climbing game, but one that's nice. it's an open game about opt-in challenge. about finding climbing paths and attempting them. it's a world for players to find a far-off spire, play tag, or dance, while chatting about their day.
	- **who are we**
	  collapsed:: true
	  2 14s 43w
		...
		- and i'm moochi
		  background-color:: pink
		- we started this game as our master's thesis. we've been working on it since alongside an amazing community of collaborators, mentors and peers in brooklyn.
	- **the best 3d platformer ever**
	  ...
	  3 35s 107w
		...
		- big claim, we know.
		  background-color:: green
		- we've dialed in the fundamentals: moving and jumping. simply moving your character around (even jumping in place!) should be an endless source of discovery.
		...
		- and **momentum** is not only about fast, flowing lines. it's also careful and considered. changing a single step might be all it takes reach the next ridge.
		- the climb is the joy of exploring the nuances of your character and its interaction with...
	- **"openness" & discovery**
	  collapsed:: true
	  3 25s 92w
		- ...an open, free, unknown world.
		- we're building a world that eases you in through designed structures, but removes them as you ascend. until only organic boulders remain.
		- this openness is the chance to pick a route, try a jump, or recover from a mistake not only that you never have before, but that **nobody** has before. a real discovery, and it's **yours**.
	...
	- **multiplayer**
	  collapsed:: true
	  5 ??s 146w
		- it's an online game. you don't have to struggle alone. you can learn from others and share what you know with them, too. you might find a flower left by another player that entices you forward. you might find that player, and chase them as they run away from you. you might challenge each other to a race, to jump a difficult gap, or to a game of horse.
		- we're both passionate about folk games. tag, tug-of-war: the ones you might've played as a kid. twitch streamers already play hide-and-seek online in mario odyssey, we want discone to bring that spirit to everyone. to create a world for players to play their own games, to hide in funny places together.
	...
	- **for tryhards, for casual groups of friends, for...**
	  collapsed:: true
	  2 ??s 66w
		- we're making this game for many people. for casual groups of friends looking for a run-and-jump hike together while chit-chatting.
		- for tryhards who want to refine their movement down to the last nuance, to become untaggable, to optimize routes, to make a world-first summit.
		- for committed groups of gamers who want to follow one another to far-off vistas, to scale every tower, to unravel the deep lore.
		- ...
	- **scale / market of references** 
	  collapsed:: true
	  6 ??s 210w (with stats => 279w)
		- let's look at some market references for these sorts of players
		- golf with your friends has sold millions of copies with a 9-year long tail. it remains successful as an option for casual groups looking for tonight's chill game.
		  collapsed:: true
			- (it was released in 2020 and moved an estimated 60 thousand copies in april 2025.)
		- discone is made for players that might buy a game and play it twice, who will later convince new friends to grab it during the next sale, or when an update drops. our own long tail is a stream of new characters^, locations^, items^, folk games^.
		- roblox: in 2025, it averages millions of concurrent players. obbys^, exploration games, even hide and seek are an extremely popular, durable category.
		  collapsed:: true
		...
		- we're neither free-to-play nor everywhere like roblox. but the generation invested in obbys and playing with others now *will* graduate to steam. discone manifests that community's spirit in a more considered game. (and it only has one button, we can bring it to mobile ;)).
		...
		- these maps are "skateparks" for casual players to try their first trick, for tryhards to showoff their 30th. beyond parks, the diverse, analog movement of multiple characters and focus on open play in discone *also* embrace *street* skating. a *world* for spectatorship to inspire awe or to drive you further.
	- **appeal to streamers**
	  collapsed:: true
	  1 ??s 32w
		- and discone is built for modern spectatorship: streaming. for speed running up seemingly insurmountable mountain routes, for co-streaming a big game of hide-and-seek, for the schadenfreude of the "foddian" rage game...
	- **but we are different...**
	  collapsed:: true
	  2 ??s 60w
		- but. discone is different from these references. it's about the freedom to explore, to choose your challenges. to replace "rage" with "play". it has no arbitrary difficulty: no magnets, no invisible walls, no kaizo blocks^.
	...
	- **rapid-fire list of future features**
	  collapsed:: true
	  1 ??s 23w
		- and we have a lot in mind for the future that won't fit in this video. we'd love to chat about it later.
	- **roadmap/timeline**
	  collapsed:: true
	  3 ??s 94w
		- we've planned a roadmap with **2 years** to initial release. presently, we're in **pre-production** and developing our content creation pipeline.
		- we're targeting **12 months** to finish our **vertical slice**, a representative "content pack": a character to play, regions to explore, toys to play with, cosmetics for personalization.
	...
	- **budget**
	  collapsed:: true
	  1 ??s 40w
		- we're asking for $550,000 to support our 2-year release plan. that covers our full-time design & development costs, hiring people part-time for art & sound, and fixed production costs like studio space, tools, et cetera.
	- **thanks**
	  collapsed:: true
	  1 ??s 15w
...
- wip
  id:: 6808f7a0-1e9b-492a-9aec-d3358622fa6a
	- DONE layout everything in davinci resolve #publishing
	- TODO record audio #publishing #audio
	- **intro**
	...
	- **multiplayer**
		...
		- TODO shot 25: streamers playing [[mario odyssey]] hide and seek #footage/reference #publishing
